...
- [Version 1.3.5 Yoast SEO Title Template Preparation](version-1.3.5-yoast-seo-title-template-preparation.md) - Root cause, Yoast-native template correction, focused regression coverage, and local Browser/runtime evidence for the unpublished release.
